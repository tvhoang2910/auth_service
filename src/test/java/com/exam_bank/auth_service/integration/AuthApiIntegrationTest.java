...
class AuthApiIntegrationTest {
        ...
        void setUp() {
                ...
                Mockito.doAnswer(invocation -> {
                        ...
                        String otpValue = invocation.getArgument(2);
                        String emailValue = invocation.getArgument(3);
                        redisValues.put(keys.get(0), otpValue);
                        redisValues.put(keys.get(1), emailValue);
                        return 1L;
